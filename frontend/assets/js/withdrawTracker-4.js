...
async function start() {
    ...
    setElements(sendPriceBitcoin, Number(setPriceBitcoin).toFixed(8), Number(getPriceInEuro.price).toFixed(2), qr, (setPriceBitcoinCommission).toFixed(8), Number(getPriceInEuroCommission.price).toFixed(2), address.address)
